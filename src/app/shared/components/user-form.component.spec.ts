...
describe('UserFormComponent', () => {
  ...
  describe('Form Interactions', () => {
    it('should update name field when typed', () => {
      TestUtils.setInputValue(fixture, '[data-testid="name-input"]', 'Jane Doe');
      
      expect(component.formData.name).toBe('Jane Doe');
    });

    it('should update email field when typed', () => {
      TestUtils.setInputValue(fixture, '[data-testid="email-input"]', 'jane@example.com');
      
      expect(component.formData.email).toBe('jane@example.com');
    });

    it('should toggle active checkbox', () => {
      const checkbox = TestUtils.querySelector<HTMLInputElement>(fixture, '[data-testid="active-checkbox"]');
  ...
  describe('Form Submission', () => {
    ...
    it('should show submit button as disabled when submitting', () => {
      ...
      const submitButton = TestUtils.querySelector<HTMLButtonElement>(fixture, '[data-testid="submit-button"]');
    ...
    it('should trigger form submission when submit button is clicked', () => {
      ...
      const submitButton = TestUtils.querySelector(fixture, '[data-testid="submit-button"]');
  ...
  describe('Form Cancellation', () => {
    it('should emit userCancel event when cancel button is clicked', () => {
      ...
      const cancelButton = TestUtils.querySelector(fixture, '[data-testid="cancel-button"]');
  ...
  describe('Message Display', () => {
    it('should show success message when showSuccess is called', () => {
      ...
      TestUtils.expectElementToExist(fixture, '[data-testid="success-message"]');
      TestUtils.expectElementToHaveText(fixture, '[data-testid="success-message"]', 'User saved successfully!');
      TestUtils.expectElementNotToExist(fixture, '[data-testid="error-message"]');
    });
    ...
    it('should show error message when showError is called', () => {
      ...
      TestUtils.expectElementToHaveText(fixture, '[data-testid="error-message"]', 'Failed to save user!');
      TestUtils.expectElementNotToExist(fixture, '[data-testid="success-message"]');
    });
  ...
  describe('Integration Tests', () => {
    it('should complete full form workflow', async () => {
      ...
      // Fill out the form
      TestUtils.setInputValue(fixture, '[data-testid="name-input"]', 'John Doe');
      TestUtils.setInputValue(fixture, '[data-testid="email-input"]', 'john@example.com');
